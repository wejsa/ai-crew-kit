...
| 4 — security-migration.md + CHANGELOG + VERSION → alpha.4 | ✅ 완료 | PR #39 머지 (6cf43c9) — security-migration.md 11 섹션 신규 + CHANGELOG Added/Changed/Fixed/Breaking Phase 5 entries + VERSION/README alpha.4. 리뷰 후속 H001(PR #34 Fixed 서브섹션 신설) / M001(점수 영향 ≤1점 정확화 — Hamilton vs floor 라운딩 정책 차이) 반영. **Phase 5 전체 완료** |
