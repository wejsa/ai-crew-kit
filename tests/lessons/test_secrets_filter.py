"""Secrets filter regression tests for aick-retro §5.3 (Phase 7 Step 2).

aick-retro stores lesson description after matching against
...
only — UX layer is verified via aick-retro SKILL.md spec, not pytest.
...
are handled at the AskUserQuestion layer in aick-retro, not here.
"""
...
def test_all_hardcoded_have_comment_excludecontext(hardcoded_patterns):
    """SEC-S01~S05 모두 excludeContexts에 'comment' 포함 — aick-retro가
