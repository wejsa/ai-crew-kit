---
name: crew-impl
description: 구현 - 스텝별 개발 + PR 생성. 사용자가 "개발 진행해줘", "구현해줘" 또는 /crew-impl을 요청할 때 사용합니다.
...
## 실행 조건
- 사용자가 `/crew-impl` 또는 "개발 진행해줘" 요청 시
...
## 워크플로우 상태 추적
CLAUDE.md 상태 추적 패턴. currentSkill="crew-impl"
...
### 9. 다음 스킬 호출 (프로필별)
- **standard**: `Skill tool: skill="crew-review-pr", args="{prNumber} --auto-fix"`
...
4. **라인 수 검증 (Micro 전용)**:
   ...
   - > 300줄: 차단 "Standard 경로 필요. /crew-plan 실행"
5. **빌드 & 테스트**: 일반과 동일
