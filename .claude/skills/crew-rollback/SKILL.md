---
name: crew-rollback
description: 릴리스 롤백 - git revert 기반 안전한 릴리스/PR 롤백 + 감사 추적. 사용자가 "롤백해줘" 또는 /crew-rollback을 요청할 때 사용합니다.
...
# crew-rollback: 릴리스 롤백

## 실행 조건
- `/crew-rollback v1.2.3` — 태그 기반 롤백
- `/crew-rollback #123` — PR 기반 롤백
