---
name: aick-docs
description: 프로젝트 참고자료 - 개발 시 자동 참조되는 공통 컨벤션·문서. 사용자가 "문서 찾아줘", "참고자료" 또는 /aick-docs를 요청할 때 사용합니다.
...
```
/aick-docs                    # 전체 문서 목록
/aick-docs payment            # 결제 관련 문서
/aick-docs api                # API 설계 문서
/aick-docs template api-spec  # 템플릿 출력
```
