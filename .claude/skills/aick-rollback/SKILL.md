---
name: aick-rollback
description: 릴리스 롤백 - git revert 기반 안전한 릴리스/PR 롤백 + 감사 추적. 사용자가 "롤백해줘" 또는 /aick-rollback을 요청할 때 사용합니다.
disable-model-invocation: false
allowed-tools: Bash(git:*), Bash(gh:*), Read, Write, Edit, Glob
disallowed-tools: Task, WebFetch, WebSearch, NotebookEdit
...
## 실행 조건
- `/aick-rollback v1.2.3` — 태그 기반 롤백
- `/aick-rollback #123` — PR 기반 롤백
