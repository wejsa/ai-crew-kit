---
name: crew-hotfix
description: main 긴급 수정 - 핫픽스 브랜치 + 보안 리뷰 + 패치 릴리스 + develop 백머지. 사용자가 "긴급 수정해줘" 또는 /crew-hotfix를 요청할 때 사용합니다.
...
# crew-hotfix: main 긴급 수정

## 실행 조건
- `/crew-hotfix "설명"` 또는 "긴급 수정해줘: 설명" 요청 시
...
### 4. 빌드/테스트 검증
buildCommands 우선 → techStack 폴백 (crew-release와 동일 패턴)
