...
Issue #62 (v2.1.0 PR #61 후속) — crew-init Step 9 백로그 자동 분해 결과의 회귀 보호.

`tests/crew-init/test_schema_compliance.py`가 pytest로 본 디렉토리의 fixture를 모두 검증.
...
- positive 케이스 추가: crew-init Step 9 신규 분기/필드 도입 시 함께 추가
...
- pytest 검증: `pytest tests/crew-init/test_schema_compliance.py -v`
